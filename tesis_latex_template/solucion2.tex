\chapter{Sistema de conversión punto flotante a punto fijo y normalización }
...
\item \nt{Begin\_FF}: Este se encarga de iniciar la la unidad, indica a la máquina de estados que inicia la secuencia. 

\item \nt{RST\_FF}: Este se encarga restablecer los valores iniciales del sistema de conversión y normalización.
...
\section{Resultados de la simulación del circuito convertidor-normalizador}
